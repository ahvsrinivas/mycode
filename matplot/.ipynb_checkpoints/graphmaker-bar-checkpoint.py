...
def main():
    ...
    p1 = plt.bar(ind, localnetMeans, width)                  # describe where to display p1
    ...
    plt.savefig("/home/student/mycode/matplot/2018summary.png")
